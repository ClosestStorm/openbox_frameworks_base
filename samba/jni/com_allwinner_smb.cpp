...
#define SMB_PACKAGE ("com/allwinner/netshare/SmbFile")
#define SMB_Callback ("com/allwinner/netshare/OnReceiverListenner")
...
static int Smb_listCallbackImpl(JNIEnv* env, jclass, jstring javaPath, jobject obj) {
	...
	jcallback = env->GetMethodID(jbackobj, "onReceiver",
						"(Lcom/allwinner/netshare/SmbFile;)V");
	if(jcallback == NULL){
...
static JNINativeMethod Methods[] = {
    ...
    NATIVE_METHOD(Smb, listImpl, "(Ljava/lang/String;)[Lcom/allwinner/netshare/SmbFile;"),
    NATIVE_METHOD(Smb, listCallbackImpl, "(Ljava/lang/String;Lcom/allwinner/netshare/OnReceiverListenner;)I"),
