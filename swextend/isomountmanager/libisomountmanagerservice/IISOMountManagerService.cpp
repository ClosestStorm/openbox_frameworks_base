...
//		if(DEBUG)
//			LOGV("isoMount()..mountPath = %s, isoPath = %s", mountPath, isoPath);
		Parcel data, reply;
...
//		if(DEBUG)
//			LOGV("isoUmount()..mountPath = %s", mountPath);
		Parcel data, reply;
        data.writeInterfaceToken(IISOMountManagerService::getInterfaceDescriptor());
        data.writeCString(mountPath);
...
//		if(DEBUG)
//			LOGV("getMountInfoList()..length = %d", length);
		Parcel data, reply;
        data.writeInterfaceToken(IISOMountManagerService::getInterfaceDescriptor());
...
//		if(DEBUG)
//			LOGV("getISOPath()..mountPath = %s", mountPath);
		Parcel data, reply;
        data.writeInterfaceToken(IISOMountManagerService::getInterfaceDescriptor());
        data.writeCString(mountPath);
...
//		if(DEBUG)
//			LOGV("getMountPoints()..isoPath = %s", isoPath);
		Parcel data, reply;
		data.writeInterfaceToken(IISOMountManagerService::getInterfaceDescriptor());
		data.writeCString(isoPath);
		data.writeInt32(length);
...
//		if(DEBUG)
//			LOGV("getISOMountCount()..isoPath = %s", isoPath);
		Parcel data, reply;
        data.writeInterfaceToken(IISOMountManagerService::getInterfaceDescriptor());
        data.writeCString(isoPath);
...
IMPLEMENT_META_INTERFACE(ISOMountManagerService, "com.allwinner.IISOMountManagerService");
