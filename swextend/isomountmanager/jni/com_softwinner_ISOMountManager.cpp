...
{
//	LOGV("com_softwinner_ISOMountManager_mount");
...
//	LOGV("com_softwinner_ISOMountManager_umount");
	if(mIISOMountManagerService == NULL){
		jniThrowException(env, "java/lang/IllegalStateException", NULL);
		return -1;
	}
...
{
//	LOGV("com_softwinner_ISOMountManager_umountAll");
	if(mIISOMountManagerService == NULL){
		jniThrowException(env, "java/lang/IllegalStateException", NULL);
		return false;
	}
...
{
//	LOGV("com_softwinner_ISOMountManager_getMountInfoList");
    ...
    if(classMountInfo == NULL ){
        LOGE("Fail in finding class com/softwinner/ISOMountManager$MountInfo");
        return NULL;
    }
...
{
//    LOGV("com_softwinner_ISOMountManager_getMountPoints");
...
{
//    LOGD("com_softwinner_ISOMountManager_init");
    ...
    do {
        ...
        if (binder != 0) {
       	...
       	LOGW("softwinner isomountmanager service not published, waiting...");
       	usleep(500000); // 0.5 s
    } while(true);
