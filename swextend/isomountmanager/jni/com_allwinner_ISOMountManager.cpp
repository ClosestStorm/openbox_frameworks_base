 ...
 */
static jint
com_allwinner_ISOMountManager_mount(JNIEnv *env, jobject thiz, jstring mountPath, jstring isoPath)
{
//	LOGV("com_allwinner_ISOMountManager_mount");
 ...
 */
static jint
com_allwinner_ISOMountManager_umount(JNIEnv *env, jobject thiz, jstring mountPath){
//	LOGV("com_allwinner_ISOMountManager_umount");
	if(mIISOMountManagerService == NULL){
		jniThrowException(env, "java/lang/IllegalStateException", NULL);
		return -1;
	}
...
static jboolean
com_allwinner_ISOMountManager_umountAll(JNIEnv *env, jobject thiz)
{
//	LOGV("com_allwinner_ISOMountManager_umountAll");
	if(mIISOMountManagerService == NULL){
		jniThrowException(env, "java/lang/IllegalStateException", NULL);
		return false;
	}
...
static jobject _composeObjMountInfo(JNIEnv *env, jclass classMountInfo, jmethodID methodMountInfo, ISOMountManager_MountInfo *info)
{
    ...
    if(objMountInfo == NULL )
        LOGE("Fail in creating MountInfo object.");
...
static jobjectArray
com_allwinner_ISOMountManager_getMountInfoList(JNIEnv *env, jobject thiz)
{
//	LOGV("com_allwinner_ISOMountManager_getMountInfoList");
    ...
    classMountInfo = env->FindClass("com/allwinner/ISOMountManager$MountInfo");
    if(classMountInfo == NULL ){
        LOGE("Fail in finding class com/allwinner/ISOMountManager$MountInfo");
        return NULL;
    }
    ...
    if(jmountList == NULL){
        LOGE("Fail in creating MountInfo array.");
        goto error;
    }
...
static jstring
com_allwinner_ISOMountManager_getIsoPath(JNIEnv *env, jobject thiz, jstring mountPath)
{
//	LOGV("com_allwinner_ISOMountManager_umount");
    ...
    if(ret){
		jisoPath = env->NewStringUTF(cisoPath);
   		if(jisoPath == NULL){
   			LOGE("Fail in creating java string with %s.", cisoPath);
   		}
    }
   	delete[] cisoPath;
   	env->ReleaseStringUTFChars(mountPath, ctarget);
...
static jobjectArray
com_allwinner_ISOMountManager_getMountPoints(JNIEnv *env, jobject thiz, jstring isoPath)
{
//    LOGV("com_allwinner_ISOMountManager_getMountPoints");
...
static void
com_allwinner_ISOMountManager_init(JNIEnv *env)
{
//    LOGD("com_allwinner_ISOMountManager_init");
    
    sp<IServiceManager> sm = defaultServiceManager();
    sp<IBinder> binder;
    do {
        binder = sm->getService(String16("allwinner.isomountmanager"));
        if (binder != 0) {
            break;
        }
       	LOGW("allwinner isomountmanager service not published, waiting...");
       	usleep(500000); // 0.5 s
    } while(true);
...
static JNINativeMethod gMethods[] = {
    {"init",         		"()V",                              				(void *)com_allwinner_ISOMountManager_init},
    {"mount",        		"(Ljava/lang/String;Ljava/lang/String;)I",			(void *)com_allwinner_ISOMountManager_mount},
    {"umount",     			"(Ljava/lang/String;)I",                   			(void *)com_allwinner_ISOMountManager_umount},
    {"umountAll",			"()V",												(void *)com_allwinner_ISOMountManager_umountAll},
    {"getMountInfoList",	"()[Lcom/allwinner/ISOMountManager$MountInfo;",	(void *)com_allwinner_ISOMountManager_getMountInfoList},
    {"getIsoPath",			"(Ljava/lang/String;)Ljava/lang/String;",			(void *)com_allwinner_ISOMountManager_getIsoPath},		  
    {"getMountPoints",		"(Ljava/lang/String;)[Ljava/lang/String;",			(void *)com_allwinner_ISOMountManager_getMountPoints},
};

static const char* const kClassPathName = "com/allwinner/ISOMountManager";

// This function only registers the native methods
static int register_com_allwinner_ISOMountManager(JNIEnv *env)
{
...
//    LOGD("JNI_OnLoad()");
    ...
    if (register_com_allwinner_ISOMountManager(env) < 0) {
        LOGE("ERROR: ISOMountManager native registration failed\n");
        goto bail;
    }
