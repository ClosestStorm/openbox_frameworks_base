...
public class DispList extends Handler{
     ...
     * display format list
     */
    public static final DispFormat DISP_FORMAT_NTSC             = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_TV  , DisplayManager.DISPLAY_TVFORMAT_NTSC);
    public static final DispFormat DISP_FORMAT_PAL              = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_TV  , DisplayManager.DISPLAY_TVFORMAT_PAL);
    public static final DispFormat DISP_FORMAT_YPBPR_480I       = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_TV  , DisplayManager.DISPLAY_TVFORMAT_480I );
    public static final DispFormat DISP_FORMAT_YPBPR_480P       = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_TV  , DisplayManager.DISPLAY_TVFORMAT_480P );
    public static final DispFormat DISP_FORMAT_YPBPR_576I       = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_TV  , DisplayManager.DISPLAY_TVFORMAT_576I );
    public static final DispFormat DISP_FORMAT_YPBPR_576P       = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_TV  , DisplayManager.DISPLAY_TVFORMAT_576P );
    public static final DispFormat DISP_FORMAT_YPBPR_720P_50HZ  = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_TV  , DisplayManager.DISPLAY_TVFORMAT_720P_50HZ );
    public static final DispFormat DISP_FORMAT_YPBPR_720P_60HZ  = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_TV  , DisplayManager.DISPLAY_TVFORMAT_720P_60HZ );
    public static final DispFormat DISP_FORMAT_YPBPR_1080P_50HZ = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_TV  , DisplayManager.DISPLAY_TVFORMAT_1080P_50HZ );
    public static final DispFormat DISP_FORMAT_YPBPR_1080P_60HZ = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_TV  , DisplayManager.DISPLAY_TVFORMAT_1080P_60HZ );
    public static final DispFormat DISP_FORMAT_HDMI_480I        = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI, DisplayManager.DISPLAY_TVFORMAT_480I );
    public static final DispFormat DISP_FORMAT_HDMI_480P        = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI, DisplayManager.DISPLAY_TVFORMAT_480P );
    public static final DispFormat DISP_FORMAT_HDMI_576I        = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI, DisplayManager.DISPLAY_TVFORMAT_576I );
    public static final DispFormat DISP_FORMAT_HDMI_576P        = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI, DisplayManager.DISPLAY_TVFORMAT_576P );
    public static final DispFormat DISP_FORMAT_HDMI_720P_50HZ   = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI, DisplayManager.DISPLAY_TVFORMAT_720P_50HZ );
    public static final DispFormat DISP_FORMAT_HDMI_720P_60HZ   = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI, DisplayManager.DISPLAY_TVFORMAT_720P_60HZ );
    public static final DispFormat DISP_FORMAT_HDMI_1080I_50HZ  = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI, DisplayManager.DISPLAY_TVFORMAT_1080I_50HZ);
    public static final DispFormat DISP_FORMAT_HDMI_1080I_60HZ  = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI, DisplayManager.DISPLAY_TVFORMAT_1080I_60HZ);
    public static final DispFormat DISP_FORMAT_HDMI_1080P_24HZ  = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI, DisplayManager.DISPLAY_TVFORMAT_1080P_24HZ);
    public static final DispFormat DISP_FORMAT_HDMI_1080P_50HZ  = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI, DisplayManager.DISPLAY_TVFORMAT_1080P_50HZ);
    public static final DispFormat DISP_FORMAT_HDMI_1080P_60HZ  = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI, DisplayManager.DISPLAY_TVFORMAT_1080P_60HZ);
    public static final DispFormat DISP_FORMAT_VGA_640_480      = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_VGA , DisplayManager.DISPLAY_VGA_H640_V480  );
    public static final DispFormat DISP_FORMAT_VGA_800_600      = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_VGA , DisplayManager.DISPLAY_VGA_H800_V600  );
    public static final DispFormat DISP_FORMAT_VGA_1024_768     = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_VGA , DisplayManager.DISPLAY_VGA_H1024_V768 );
    public static final DispFormat DISP_FORMAT_VGA_1280_720     = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_VGA , DisplayManager.DISPLAY_VGA_H1280_V720 );
    public static final DispFormat DISP_FORMAT_VGA_1280_1024    = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_VGA , DisplayManager.DISPLAY_VGA_H1280_V1024);
    public static final DispFormat DISP_FORMAT_VGA_1360_768     = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_VGA , DisplayManager.DISPLAY_VGA_H1360_V768 );
    public static final DispFormat DISP_FORMAT_VGA_1440_900     = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_VGA , DisplayManager.DISPLAY_VGA_H1440_V900 );
    public static final DispFormat DISP_FORMAT_VGA_1680_1050    = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_VGA , DisplayManager.DISPLAY_VGA_H1680_V1050);
    public static final DispFormat DISP_FORMAT_VGA_1920_1080    = new DispFormat(DisplayManager.DISPLAY_OUTPUT_TYPE_VGA , DisplayManager.DISPLAY_VGA_H1920_V1080);
...
//        initToast();
    ...
    public static boolean isHDMI(DispFormat format){
        if(format.mOutputType == DisplayManager.DISPLAY_OUTPUT_TYPE_HDMI)
            return true;
        else
            return false;
    }
    ...
    public static boolean isVGA(DispFormat format){
        if(format.mOutputType == DisplayManager.DISPLAY_OUTPUT_TYPE_VGA)
            return true;
        else
            return false;
    }
